...
public class MovieRankIterator implements Iterator<MovieRankRecord> {
    ...
    public MovieRankRecord next() {
        ...
        return movie == null // if true - broken state: movie rating is in ranking DB, but absent in movie DB
                ? new MovieRankRecord(Movie.EMPTY, rank) // degrade
